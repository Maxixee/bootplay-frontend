                ...
                {/* Container */}
                    <div className="flex max-w-[544px] bg-white p-10 rounded-xl">
                        <div className="flex flex-col items-center w-full gap-2">
                            ...
                            <p className="text-xs font-light flex">Ainda não tem conta ? <p onClick={handleNavigateRegister} className="font-semibold underline cursor-pointer">Inscrever-se</p></p>
                        {/* From */}
                        </div>
                    </div>
                {/* Container */}
